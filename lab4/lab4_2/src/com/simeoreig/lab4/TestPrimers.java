...
public class TestPrimers {
	...
	public static void main(String[] args) {
		...
		//
		//  El constructor ens obliga a passar-li el paràmetre de la versió que volem
		//  També podré tenir dues o més versions diferents (en aquest cas de versió que crida)
		//
		
		Primers myPrimerV4 = new Primers(4);
		
		
		if (!myPrimerV4.comprovaLlistaConegudaPrimers_v1(Primers.primesFrom2two80k)) {
		...
		for (long numActual: arrayProves) {
			...
			esPrimer = myPrimerV4.esNumeroPrimer(numActual); 
