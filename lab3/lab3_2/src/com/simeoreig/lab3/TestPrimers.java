...
public class TestPrimers {
	...
	public static void main(String[] args) {
		...
		//Fem un joc de proves que testa l'algoritme abans d'executar el cos del programa
		...
		for (long numActual: arrayProves) {
			...
			esPrimer = Primers.esNumeroPrimer_v2(numActual); // Hem afegit una nova versió de 'esNumeroPrimer'
